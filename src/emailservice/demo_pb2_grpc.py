...
class FaultServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Create = channel.unary_unary(
        '/hipstershop.FaultService/Create',
        request_serializer=demo__pb2.CreateRequest.SerializeToString,
        response_deserializer=demo__pb2.Empty.FromString,
        )
    self.Delete = channel.unary_unary(
        '/hipstershop.FaultService/Delete',
        request_serializer=demo__pb2.DeleteRequest.SerializeToString,
        response_deserializer=demo__pb2.Empty.FromString,
        )
...
def add_FaultServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Create': grpc.unary_unary_rpc_method_handler(
          servicer.Create,
          request_deserializer=demo__pb2.CreateRequest.FromString,
          response_serializer=demo__pb2.Empty.SerializeToString,
      ),
      'Delete': grpc.unary_unary_rpc_method_handler(
          servicer.Delete,
          request_deserializer=demo__pb2.DeleteRequest.FromString,
          response_serializer=demo__pb2.Empty.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'hipstershop.FaultService', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
...
def add_TestServiceServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'hipstershop.TestService', rpc_method_handlers)
  server.add_generic_rpc_handlers((generic_handler,))
