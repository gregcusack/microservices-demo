...
func init() {
	proto.RegisterType((*EmptyMsg)(nil), "faultservice.EmptyMsg")
	proto.RegisterType((*ExperimentReq)(nil), "faultservice.ExperimentReq")
	proto.RegisterType((*InfoMsg)(nil), "faultservice.InfoMsg")
}
...
var fileDescriptor_e5747b2e02f0c537 = []byte{
	...
	,
}
...
func (c *faultServiceClient) Experiment(ctx context.Context, in *EmptyMsg, opts ...grpc.CallOption) (FaultService_ExperimentClient, error) {
	stream, err := c.cc.NewStream(ctx, &_FaultService_serviceDesc.Streams[0], "/faultservice.FaultService/Experiment", opts...)
	if err != nil {
		return nil, err
	}
...
var _FaultService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "faultservice.FaultService",
